...
@Component({
  selector: 'app-visualizar-mascotas-disponibles',
  templateUrl: './visualizar-mascotas-disponibles.html',
  styleUrls: ['./visualizar-mascotas-disponibles.component.scss']
})

export class VisualizarMascotasDisponiblesComponent implements OnInit {
...
*/
  ...
  */
  ...
  unirMascotas(dataAdop: any, dataBoth: any, dataProv: any) {
    this.mascotasPubAdopcion = [];
    // Junto los de "En adopción" con los de "En adopción y en provisorio"
    let data = undefined;

    data = [].concat(dataAdop, dataBoth, dataProv);
  ...
  async buscar() {
    ...
    this.registroMascotasService.getMascotasFiltradas(filters).subscribe(dataAdop => {
      ...
      this.registroMascotasService.getMascotasFiltradas(filters).subscribe(dataBoth => {
        ...
        this.registroMascotasService.getMascotasFiltradas(filters).subscribe(dataProv => {
          this.unirMascotas(dataAdop, dataBoth, dataProv);
        })
