...
@Component({
  selector: 'app-visualizar-provisorios',
  templateUrl: './visualizar-provisorios.component.html',
  styleUrls: ['./visualizar-provisorios.component.scss']
})

export class VisualizarProvisoriosComponent implements OnInit {
